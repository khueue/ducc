...
### ducc -t suite/noisy/medium/circle.c gives:
	...
	[{proc,{label,"drawpos"},
	       ...
	       [{cjump,eq,{temp,2},0,{label,101}},
	        ...
	        {arrelem},
	        {icon,'#'},
	        {eval,{temp,5},{'=',{temp,3},{temp,4}}},
	        {jump,{label,102}},
	        {labdef,{label,101}},
	        {icon,0},
	        {arrelem},
	        {icon,' '},
	        {eval,{temp,8},{'=',{temp,6},{temp,7}}},
	        {labdef,{label,102}},
	        {icon,1},
	        {arrelem},
	        {icon,0},
	        {eval,{temp,11},{'=',{temp,9},{temp,10}}},
	        {eval,{temp,12},{icon,0}},
	        {eval,{temp,13},{'+',{temp,1},{temp,12}}},
	 ...
	 {proc,{label,"nl"},
	       ...
	       [{icon,0},
	        {arrelem},
	        {icon,'\\n'},
	        {eval,{temp,17},{'=',{temp,15},{temp,16}}},
	        {icon,1},
	        {arrelem},
	        {icon,0},
	        {eval,{temp,20},{'=',{temp,18},{temp,19}}},
	        {eval,{temp,21},{icon,2}},
	        {eval,{temp,22},{'+',{temp,1},{temp,21}}},
	 ...
	 {proc,{label,"main"},
	       ...
	       [{icon,9},
	        {unop},
	        {eval,{temp,27},{'=',{temp,24},{temp,26}}},
	        {jump,{label,105}},
	        {labdef,{label,106}},
	        {icon,20},
	        {unop},
	        {eval,{temp,31},{'=',{temp,25},{temp,30}}},
	        {call,{temp,32},{label,"nl"},[]},
	        {jump,{label,108}},
	        {labdef,{label,109}},
	        {eval,{temp,35},{'*',{temp,24},{temp,24}}},
	        {icon,22},
	        {eval,{temp,37},{'*',{temp,35},{temp,36}}},
	        {icon,22},
	        {eval,{temp,39},{'*',{temp,37},{temp,38}}},
	        {icon,10},
	        {icon,10},
	        {eval,{temp,42},{'*',{temp,40},{temp,41}}},
	        {eval,{temp,43},{'/',{temp,39},{temp,42}}},
	        {eval,{temp,44},{'*',{temp,25},{temp,25}}},
	        {eval,{temp,45},{'+',{temp,43},{temp,44}}},
	        {icon,380},
	        {eval,{temp,47},{'>',{temp,45},{temp,46}}},
	        {call,{temp,48},{label,"drawpos"},[{temp,47}]},
	        {icon,1},
	        {eval,{temp,50},{'+',{temp,25},{temp,49}}},
	        {eval,{temp,51},{'=',{temp,25},{temp,50}}},
	        {labdef,{label,108}},
	        {icon,20},
	        {eval,{temp,34},{'<=',{temp,25},{temp,33}}},
	        {cjump,neq,{temp,34},0,{label,109}},
	        {labdef,{label,110}},
	        {icon,1},
	        {eval,{temp,53},{'+',{temp,24},{temp,52}}},
	        {eval,{temp,54},{'=',{temp,24},{temp,53}}},
	        {labdef,{label,105}},
	        {icon,9},
	        {eval,{temp,29},{'<=',{temp,24},{temp,28}}},
...
### ducc -t suite/noisy/medium/fac-b.c gives:
	...
	[{proc,{label,"fac"},
	       ...
	       [{icon,0},
	        ...
	        {labdef,{label,101}},
	        {icon,1},
	        {eval,{temp,7},{'-',{temp,2},{temp,6}}},
	        {call,{temp,8},{label,"fac"},[{temp,7}]},
	        {eval,{temp,9},{'*',{temp,2},{temp,8}}},
	        {jump,{label,100}},
	        {labdef,{label,102}}],
	       {labdef,{label,100}}},
	 [],
	 {proc,{label,"main"},
	       ...
	       [{icon,0},
	        ...
	        {arrelem},
	        {icon,0},
	        {eval,{temp,23},{'=',{temp,21},{temp,22}}},
	        {icon,0},
	        {eval,{temp,25},{'=',{temp,11},{temp,24}}},
	        {jump,{label,104}},
	        {labdef,{label,105}},
	        {call,{temp,28},{label,"putint"},[{temp,11}]},
	        {eval,{temp,29},{icon,0}},
	        {eval,{temp,30},{'+',{temp,1},{temp,29}}},
	        {call,{temp,31},{label,"putstring"},[{temp,30}]},
	        {call,{temp,32},{label,"fac"},[{temp,11}]},
	        {call,{temp,33},{label,"putint"},[{temp,32}]},
	        {eval,{temp,34},{icon,2}},
	        {eval,{temp,35},{'+',{temp,1},{temp,34}}},
	        {call,{temp,36},{label,"putstring"},[{temp,35}]},
	        {icon,1},
	        {eval,{temp,38},{'+',{temp,11},{temp,37}}},
	        {eval,{temp,39},{'=',{temp,11},{temp,38}}},
	        {labdef,{label,104}},
	        {icon,10},
	        {eval,{temp,27},{'<=',{temp,11},{temp,26}}},
...
### ducc -t suite/noisy/medium/fac.c gives:
	...
	[{proc,{label,"fac"},
	 ...
	 {proc,{label,"main"},
	       [],
	       [{temp,10},{temp,11},{temp,12},{temp,10},{temp,13},{temp,14}],
	       0,
	       [{call,{temp,11},{label,"getint"},[]},
	        {eval,{temp,12},{'=',{temp,10},{temp,11}}},
...
### ducc -t suite/noisy/simple/sim01.c gives:
	...
	[{proc,{label,"main"},
	       ...
	       [{temp,2},{temp,3}],
	       0,
	       [{icon,42},{call,{temp,3},{label,"putint"},[{temp,2}]}],
	       {labdef,{label,100}}}].
	...
	[{data,{label,100},long},
	 {proc,{label,"main"},
	       ...
	       [{eval,{temp,3},{labref,{label,100}}},
	        ...
	        {icon,76},
	        {eval,{temp,6},{'=',{temp,4},{temp,5}}},
	        {icon,54321},
	        {eval,{temp,8},{'=',{temp,2},{temp,7}}},
	...
	[{data,{label,100},7},
	 {proc,{label,"main"},
	       ...
	       [{icon,0},
	        ...
	        {arrelem},
	        {icon,l},
	        {eval,{temp,10},{'=',{temp,8},{temp,9}}},
	        {icon,3},
	        {arrelem},
	        {icon,l},
	        {eval,{temp,13},{'=',{temp,11},{temp,12}}},
	        {icon,4},
	        {arrelem},
	        {icon,o},
	        {eval,{temp,16},{'=',{temp,14},{temp,15}}},
	        {icon,5},
	        {arrelem},
	        {icon,'\\n'},
	        {eval,{temp,19},{'=',{temp,17},{temp,18}}},
	        {icon,6},
	        {arrelem},
	        {icon,0},
	        {eval,{temp,22},{'=',{temp,20},{temp,21}}},
	        {icon,0},
	        {arrelem},
	        {icon,'G'},
	        {eval,{temp,25},{'=',{temp,23},{temp,24}}},
	        {icon,1},
	        {arrelem},
	        {icon,o},
	        {eval,{temp,28},{'=',{temp,26},{temp,27}}},
	        {icon,2},
	        {arrelem},
	        {icon,o},
	        {eval,{temp,31},{'=',{temp,29},{temp,30}}},
	        {icon,3},
	        {arrelem},
	        {icon,d},
	        {eval,{temp,34},{'=',{temp,32},{temp,33}}},
	        {icon,4},
	        {arrelem},
	        {icon,' '},
	        {eval,{temp,37},{'=',{temp,35},{temp,36}}},
	        ...
	        {arrelem},
	        {icon,b},
	        {eval,{temp,40},{'=',{temp,38},{temp,39}}},
	        {icon,6},
	        {arrelem},
	        {icon,y},
	        {eval,{temp,43},{'=',{temp,41},{temp,42}}},
	        {icon,7},
	        {arrelem},
	        {icon,e},
	        {eval,{temp,46},{'=',{temp,44},{temp,45}}},
	        {icon,8},
	        {arrelem},
	        {icon,'\\n'},
	        {eval,{temp,49},{'=',{temp,47},{temp,48}}},
	        {icon,9},
	        {arrelem},
	        {icon,0},
	        {eval,{temp,52},{'=',{temp,50},{temp,51}}},
	        {eval,{temp,53},{labref,{label,100}}},
	        {call,{temp,54},{label,"putstring"},[{temp,53}]},
	        {eval,{temp,55},{icon,0}},
	        {eval,{temp,56},{'+',{temp,1},{temp,55}}},
...
### ducc -t suite/noisy/simple/sim05.c gives:
	...
	[{proc,{label,"main"},
	       ...
	       [{icon,0},
	        ...
	        {eval,{temp,19},{icon,0}},
	        {eval,{temp,20},{'+',{temp,1},{temp,19}}},
	        {call,{temp,21},{label,"putstring"},[{temp,20}]},
	        {icon,6},
	        {icon,7},
	        {eval,{temp,24},{'*',{temp,22},{temp,23}}},
	        {call,{temp,25},{label,"putint"},[{temp,24}]},
	        {eval,{temp,26},{icon,0}},
	        {eval,{temp,27},{'+',{temp,1},{temp,26}}},
	        ...
	        {icon,6},
	        {eval,{temp,34},{'*',{temp,32},{temp,33}}},
	        {eval,{temp,35},{'+',{temp,31},{temp,34}}},
	        {call,{temp,36},{label,"putint"},[{temp,35}]},
	        {eval,{temp,37},{icon,0}},
	        {eval,{temp,38},{'+',{temp,1},{temp,37}}},
	        ...
	        {icon,4},
	        {eval,{temp,45},{'*',{temp,43},{temp,44}}},
	        {eval,{temp,46},{'-',{temp,42},{temp,45}}},
	        {icon,2},
	        {eval,{temp,48},{'-',{temp,46},{temp,47}}},
	        {call,{temp,49},{label,"putint"},[{temp,48}]},
	        {eval,{temp,50},{icon,0}},
	        {eval,{temp,51},{'+',{temp,1},{temp,50}}},
	        {call,{temp,52},{label,"putstring"},[{temp,51}]},
	        {icon,6},
	        {unop},
	        {icon,7},
	        {unop},
	        {eval,{temp,55},{'*',{temp,53},{temp,54}}},
	        {call,{temp,56},{label,"putint"},[{temp,55}]},
	        {eval,{temp,57},{icon,0}},
	        {eval,{temp,58},{'+',{temp,1},{temp,57}}},
	        {call,{temp,59},{label,"putstring"},[{temp,58}]},
	        {icon,9},
	        {icon,9},
	        {eval,{temp,62},{'+',{temp,60},{temp,61}}},
	        {icon,9},
	        {eval,{temp,64},{'+',{temp,62},{temp,63}}},
	        {icon,9},
	        {icon,9},
	        {eval,{temp,67},{'+',{temp,65},{temp,66}}},
	        {icon,9},
	        {eval,{temp,69},{'/',{temp,67},{temp,68}}},
	        {eval,{temp,70},{'*',{temp,64},{temp,69}}},
	        {icon,9},
	        {icon,9},
	        {eval,{temp,73},{'*',{temp,71},{temp,72}}},
	        {icon,9},
	        {icon,9},
	        {eval,{temp,76},{'+',{temp,74},{temp,75}}},
	        {eval,{temp,77},{'-',{temp,73},{temp,76}}},
	        {eval,{temp,78},{'*',{temp,70},{temp,77}}},
	        {icon,9},
	        {icon,9},
	        {eval,{temp,81},{'+',{temp,79},{temp,80}}},
	        {icon,9},
	        {icon,9},
	        {eval,{temp,84},{'+',{temp,82},{temp,83}}},
	        {icon,9},
	        {eval,{temp,86},{'+',{temp,84},{temp,85}}},
	        {eval,{temp,87},{'*',{temp,81},{temp,86}}},
	        {eval,{temp,88},{'+',{temp,78},{temp,87}}},
	        {icon,9},
	        {icon,9},
	        {eval,{temp,91},{'*',{temp,89},{temp,90}}},
	        {icon,9},
	        {eval,{temp,93},{'+',{temp,91},{temp,92}}},
	        {eval,{temp,94},{'/',{temp,88},{temp,93}}},
	        {icon,9},
	        {icon,9},
	        {eval,{temp,97},{'/',{temp,95},{temp,96}}},
	        {eval,{temp,98},{'-',{temp,94},{temp,97}}},
	        {call,{temp,99},{label,"putint"},[{temp,98}]},
	        {eval,{temp,100},{icon,0}},
	        {eval,{temp,101},{'+',{temp,1},{temp,100}}},
	        {call,{temp,102},{label,"putstring"},[{temp,101}]},
	        {icon,6},
	        {eval,{temp,104},{'=',{temp,3},{temp,103}}},
	        {eval,{temp,105},{'=',{temp,2},{temp,104}}},
	        {icon,1},
	        {eval,{temp,107},{'+',{temp,3},{temp,106}}},
	        {eval,{temp,108},{'*',{temp,2},{temp,107}}},
	        {call,{temp,109},{label,"putint"},[{temp,108}]},
	        {eval,{temp,110},{icon,0}},
	        {eval,{temp,111},{'+',{temp,1},{temp,110}}},
	        {call,{temp,112},{label,"putstring"},[{temp,111}]},
	        {icon,5},
	        {eval,{temp,114},{'=',{temp,3},{temp,113}}},
	        {icon,3},
	        {eval,{temp,116},{'+',{temp,114},{temp,115}}},
	        {eval,{temp,117},{'=',{temp,2},{temp,116}}},
	        {eval,{temp,118},{'*',{temp,2},{temp,3}}},
	        {icon,2},
	        {eval,{temp,120},{'+',{temp,118},{temp,119}}},
	        {call,{temp,121},{label,"putint"},[{temp,120}]},
	        {eval,{temp,122},{icon,0}},
	        {eval,{temp,123},{'+',{temp,1},{temp,122}}},
	        {call,{temp,124},{label,"putstring"},[{temp,123}]},
	        {icon,3},
	        {icon,113},
	        {eval,{temp,127},{'*',{temp,125},{temp,126}}},
	        {icon,2},
	        {icon,2},
	        {eval,{temp,130},{'*',{temp,128},{temp,129}}},
	        {icon,2},
	        {icon,2},
	        {eval,{temp,133},{'*',{temp,131},{temp,132}}},
	        {eval,{temp,134},{'*',{temp,130},{temp,133}}},
	        {eval,{temp,135},{'+',{temp,127},{temp,134}}},
	        {icon,1000000},
	        {eval,{temp,137},{'*',{temp,135},{temp,136}}},
	        {icon,113},
	        {eval,{temp,139},{'/',{temp,137},{temp,138}}},
	        {call,{temp,140},{label,"putint"},[{temp,139}]},
	        {eval,{temp,141},{icon,0}},
	        {eval,{temp,142},{'+',{temp,1},{temp,141}}},
	        {call,{temp,143},{label,"putstring"},[{temp,142}]},
	        {icon,1},
	        {icon,0},
	        {eval,{temp,146},{'>',{temp,144},{temp,145}}},
	        {call,{temp,147},{label,"putint"},[{temp,146}]},
	        {icon,1},
	        {icon,0},
	        {eval,{temp,150},{'>=',{temp,148},{temp,149}}},
	        {call,{temp,151},{label,"putint"},[{temp,150}]},
	        {icon,1},
	        {icon,0},
	        {eval,{temp,154},{'==',{temp,152},{temp,153}}},
	        {call,{temp,155},{label,"putint"},[{temp,154}]},
	        {icon,1},
	        {icon,0},
	        {eval,{temp,158},{'<',{temp,156},{temp,157}}},
	        {call,{temp,159},{label,"putint"},[{temp,158}]},
	        {icon,1},
	        {icon,0},
	        {eval,{temp,162},{'<=',{temp,160},{temp,161}}},
	        {call,{temp,163},{label,"putint"},[{temp,162}]},
	        {icon,0},
	        {icon,1},
	        {eval,{temp,166},{'<',{temp,164},{temp,165}}},
	        {icon,0},
	        {icon,1},
	        {eval,{temp,169},{'<',{temp,167},{temp,168}}},
	        {eval,{temp,170},{'&&',{temp,166},{temp,169}}},
	        {call,{temp,171},{label,"putint"},[{temp,170}]},
	        {icon,0},
	        {icon,1},
	        {eval,{temp,174},{'<',{temp,172},{temp,173}}},
	        {icon,1},
	        {icon,0},
	        {eval,{temp,177},{'<',{temp,175},{temp,176}}},
	        {eval,{temp,178},{'&&',{temp,174},{temp,177}}},
	        {call,{temp,179},{label,"putint"},[{temp,178}]},
	        {icon,1},
	        {icon,0},
	        {eval,{temp,182},{'<',{temp,180},{temp,181}}},
	        {icon,0},
	        {icon,1},
	        {eval,{temp,185},{'<',{temp,183},{temp,184}}},
	        {eval,{temp,186},{'&&',{temp,182},{temp,185}}},
	        {call,{temp,187},{label,"putint"},[{temp,186}]},
	        {icon,1},
	        {icon,0},
	        {eval,{temp,190},{'<',{temp,188},{temp,189}}},
	        {icon,1},
	        {icon,0},
	        {eval,{temp,193},{'<',{temp,191},{temp,192}}},
	        {eval,{temp,194},{'&&',{temp,190},{temp,193}}},
	        {call,{temp,195},{label,"putint"},[{temp,194}]},
	        {eval,{temp,196},{icon,0}},
	        {eval,{temp,197},{'+',{temp,1},{temp,196}}},
	...
	[{data,{label,100},2},
	 {proc,{label,"main"},
	       ...
	       [{icon,10},
	        ...
	        {arrelem},
	        {icon,48},
	        {eval,{temp,10},{'+',{temp,9},{temp,2}}},
	        {icon,1},
	        {eval,{temp,12},{'-',{temp,10},{temp,11}}},
	        {eval,{temp,13},{'=',{temp,8},{temp,12}}},
	        {eval,{temp,14},{labref,{label,100}}},
	        {call,{temp,15},{label,"putstring"},[{temp,14}]},
	        {icon,1},
	        {eval,{temp,17},{'-',{temp,2},{temp,16}}},
	        {eval,{temp,18},{'=',{temp,2},{temp,17}}},
	        {labdef,{label,102}},
	...
	[{proc,{label,"foo"},
	 ...
	 {proc,{label,"g"},
	       ...
	       [{icon,0},
	        ...
	        {icon,2},
	        {icon,1},
	        {eval,{temp,21},{'-',{temp,15},{temp,20}}},
	        {call,{temp,22},{label,"g"},[{temp,21}]},
	        {eval,{temp,23},{'*',{temp,19},{temp,22}}},
	        {jump,{label,102}},
	        {labdef,{label,104}}],
	       {labdef,{label,102}}},
	 {proc,{label,"main"},
	       ...
	       [{icon,0},
	        ...
	        {icon,5},
	        {eval,{temp,32},{'=',{temp,24},{temp,31}}},
	        {icon,0},
	        {eval,{temp,34},{'+',{temp,24},{temp,33}}},
	        {icon,1},
	        {eval,{temp,36},{'+',{temp,24},{temp,35}}},
	        {icon,2},
	        {eval,{temp,38},{'+',{temp,24},{temp,37}}},
	        {eval,{temp,39},{'+',{temp,24},{temp,24}}},
	        {icon,2},
	        {eval,{temp,41},{'-',{temp,39},{temp,40}}},
	        {icon,2},
	        {eval,{temp,43},{'*',{temp,24},{temp,42}}},
	        {icon,1},
	        {eval,{temp,45},{'-',{temp,43},{temp,44}}},
	        {call,{temp,46},
	              {label,"foo"},
...
### ducc -t suite/noisy/simple/sim10.c gives:
	...
	[{proc,{label,"main"},
	       ...
	       [{icon,0},
	        ...
	        {arrelem},
	        {icon,m},
	        {eval,{temp,26},{'=',{temp,24},{temp,25}}},
	        {icon,8},
	        {arrelem},
	        {icon,e},
	        {eval,{temp,29},{'=',{temp,27},{temp,28}}},
	        {icon,9},
	        {arrelem},
	        {icon,'?'},
	        {eval,{temp,32},{'=',{temp,30},{temp,31}}},
	        {icon,10},
	        {arrelem},
	        {icon,' '},
	        {eval,{temp,35},{'=',{temp,33},{temp,34}}},
	        {icon,11},
	        {arrelem},
	        {icon,0},
	        {eval,{temp,38},{'=',{temp,36},{temp,37}}},
	        {icon,0},
	        {arrelem},
	        {icon,'Y'},
	        {eval,{temp,41},{'=',{temp,39},{temp,40}}},
	        ...
	        {arrelem},
	        {icon,r},
	        {eval,{temp,50},{'=',{temp,48},{temp,49}}},
	        {icon,4},
	        {arrelem},
	        {icon,' '},
	        {eval,{temp,53},{'=',{temp,51},{temp,52}}},
	        {icon,5},
	        {arrelem},
	        {icon,a},
	        {eval,{temp,56},{'=',{temp,54},{temp,55}}},
	        {icon,6},
	        {arrelem},
	        {icon,g},
	        {eval,{temp,59},{'=',{temp,57},{temp,58}}},
	        {icon,7},
	        {arrelem},
	        {icon,e},
	        {eval,{temp,62},{'=',{temp,60},{temp,61}}},
	        ...
	        {arrelem},
	        {icon,' '},
	        {eval,{temp,65},{'=',{temp,63},{temp,64}}},
	        {icon,9},
	        {arrelem},
	        {icon,0},
	        {eval,{temp,68},{'=',{temp,66},{temp,67}}},
	        {icon,0},
	        {arrelem},
	        {icon,'Y'},
	        {eval,{temp,71},{'=',{temp,69},{temp,70}}},
	        {icon,1},
	        {arrelem},
	        {icon,o},
	        {eval,{temp,74},{'=',{temp,72},{temp,73}}},
	        {icon,2},
	        {arrelem},
	        {icon,u},
	        {eval,{temp,77},{'=',{temp,75},{temp,76}}},
	        {icon,3},
	        {arrelem},
	        {icon,' '},
	        {eval,{temp,80},{'=',{temp,78},{temp,79}}},
	        {icon,4},
	        {arrelem},
	        {icon,a},
	        {eval,{temp,83},{'=',{temp,81},{temp,82}}},
...
### ducc -t suite/noisy/simple/sim11.c gives:
	...
	[{proc,{label,"f"},
	       [{temp,2},{temp,3}],
	       [{temp,4},{temp,2},{temp,5}],
	       0,
	       [{icon,0},{arrelem},{eval,{temp,5},{'=',{temp,4},{temp,2}}}],
	       {labdef,{label,100}}},
	 {proc,{label,"main"},
	       [],
	       [{temp,6},
	       ...
	       [{icon,10},
	        ...
	        {labdef,{label,103}},
	        {icon,48},
	        {eval,{temp,13},{'+',{temp,12},{temp,6}}},
	        {icon,1},
	        {eval,{temp,15},{'-',{temp,13},{temp,14}}},
	        {eval,{temp,16},{icon,0}},
	        {eval,{temp,17},{'+',{temp,1},{temp,16}}},
	        {call,{temp,18},{label,"f"},[{temp,15},{temp,17}]},
	        {eval,{temp,19},{icon,0}},
	        {eval,{temp,20},{'+',{temp,1},{temp,19}}},
	        {call,{temp,21},{label,"putstring"},[{temp,20}]},
	        {icon,1},
	        {eval,{temp,23},{'-',{temp,6},{temp,22}}},
	        {eval,{temp,24},{'=',{temp,6},{temp,23}}},
	        {labdef,{label,102}},
...
### ducc -t suite/quiet/lexer/l03.c gives:
	...
	[{proc,{label,"main"},
	       ...
	       [{icon,123456789},
	        {eval,{temp,4},{'=',{temp,2},{temp,3}}},
	        {icon,'0'},
	        {eval,{temp,6},{'=',{temp,2},{temp,5}}},
	        {icon,a},
	        {eval,{temp,8},{'=',{temp,2},{temp,7}}},
	        {icon,' '},
	        {eval,{temp,10},{'=',{temp,2},{temp,9}}},
	        {icon,'\\n'},
	        {eval,{temp,12},{'=',{temp,2},{temp,11}}}],
	       {labdef,{label,100}}}].
...
### ducc -t suite/quiet/lexer/l05.c gives:
	...
	[{proc,{label,"f"},
	       ...
	       0,
	       [{eval,{temp,4},{'+',{temp,2},{temp,3}}},{jump,{label,100}}],
	       {labdef,{label,100}}},
	 {proc,{label,"main"},
	       [],
	       [{temp,5},
	...
	[{data,{label,100},long},
	 ...
	 {proc,{label,"jal"},
	       ...
	       [{eval,{temp,2},{labref,{label,100}}},
	        ...
	        {eval,{temp,8},{'*',{temp,5},{temp,7}}},
	        {eval,{temp,9},{labref,{label,102}}},
	        {eval,{temp,10},{load,long,{temp,9}}},
	        {eval,{temp,11},{'+',{temp,8},{temp,10}}},
	        {eval,{temp,12},{'=',{temp,3},{temp,11}}}],
	       {labdef,{label,103}}},
	 {proc,{label,"mov"},
	       [{temp,13}],
	       [{temp,14},{temp,15},{temp,13},{temp,16}],
	       0,
	       [{eval,{temp,14},{labref,{label,101}}},
	        {eval,{temp,15},{load,byte,{temp,14}}},
	        {eval,{temp,16},{'=',{temp,15},{temp,13}}}],
	       {labdef,{label,104}}},
	 {proc,{label,"main"},
	       [],
	       [{temp,17},
...
### ducc -t suite/quiet/parser/p01.c gives:
	...
	[{proc,{label,"main"},
	       ...
	       0,
	       [{icon,42},
	        {eval,{temp,5},{'=',{temp,2},{temp,4}}},
	        {icon,4711},
	        {eval,{temp,7},{'=',{temp,3},{temp,6}}},
	        {eval,{temp,8},{'=',{temp,2},{temp,7}}}],
	       {labdef,{label,100}}}].
	...
	[{data,{label,100},long},
	 ...
	 {proc,{label,"main"},
	       ...
	       [{icon,10},
	        ...
	        {icon,2},
	        {eval,{temp,7},{'*',{temp,5},{temp,6}}},
	        {eval,{temp,8},{'-',{temp,4},{temp,7}}},
	        {icon,1},
	        {eval,{temp,10},{'-',{temp,8},{temp,9}}},
	        {eval,{temp,11},{'=',{temp,2},{temp,10}}},
	        {icon,100},
	        {eval,{temp,13},{'*',{temp,12},{temp,2}}},
	        {icon,1},
	        {eval,{temp,15},{'*',{temp,13},{temp,14}}},
	        {icon,71},
	        {eval,{temp,17},{'/',{temp,15},{temp,16}}},
	        {eval,{temp,18},{'-',{temp,2},{temp,17}}},
	        {eval,{temp,19},{'=',{temp,3},{temp,18}}},
	        {eval,{temp,20},{'=',{temp,2},{temp,19}}},
	        {eval,{temp,21},{'*',{temp,2},{temp,3}}},
	        {icon,99},
	        {eval,{temp,23},{'<',{temp,21},{temp,22}}},
	        {icon,0},
	        {eval,{temp,25},{'==',{temp,2},{temp,24}}},
	        {icon,0},
	        {eval,{temp,27},{'&&',{temp,25},{temp,26}}}],
	       {labdef,{label,102}}}].
	...
	[{data,{label,100},long},
	 ...
	 {proc,{label,"main"},
	       ...
	       [{eval,{temp,4},{labref,{label,100}}},
	        ...
	        {eval,{temp,11},{'=',{temp,9},{temp,10}}},
	        {icon,44},
	        {eval,{temp,13},{'=',{temp,2},{temp,12}}},
	        {icon,45},
	        {eval,{temp,15},{'=',{temp,3},{temp,14}}},
	...
	[{data,{label,100},long},
	 ...
	 {proc,{label,"main"},
	       ...
	       [{eval,{temp,14},{labref,{label,100}}},
	        ...
	        {arrelem},
	        {icon,17},
	        {eval,{temp,30},{'=',{temp,28},{temp,29}}},
	        {icon,7},
	        {arrelem},
	        {icon,19},
	        {eval,{temp,33},{'=',{temp,31},{temp,32}}}],
	       {labdef,{label,105}}}].
	...
	[{data,{label,100},long},
	 ...
	 {proc,{label,"main"},
	       ...
	       [{eval,{temp,4},{labref,{label,100}}},
	        ...
	        {eval,{temp,8},{labref,{label,101}}},
	        {eval,{temp,9},{load,byte,{temp,8}}},
	        {eval,{temp,10},{'+',{temp,7},{temp,9}}},
	        {eval,{temp,11},{'+',{temp,10},{temp,2}}},
	        {eval,{temp,12},{'+',{temp,11},{temp,3}}},
	        {eval,{temp,13},{'=',{temp,5},{temp,12}}},
	        {eval,{temp,14},{labref,{label,100}}},
	        {eval,{temp,15},{load,long,{temp,14}}},
	        {icon,42},
	        {eval,{temp,17},{'=',{temp,2},{temp,16}}},
	        {eval,{temp,18},{'=',{temp,15},{temp,17}}},
	        {eval,{temp,19},{labref,{label,100}}},
	        {eval,{temp,20},{load,long,{temp,19}}},
	        {eval,{temp,21},{'==',{temp,20},{temp,2}}},
	        {icon,42},
	        {eval,{temp,23},{'==',{temp,21},{temp,22}}},
	        {eval,{temp,24},{labref,{label,100}}},
	        {eval,{temp,25},{load,long,{temp,24}}},
	        {icon,99},
	        {eval,{temp,27},{'=',{temp,2},{temp,26}}},
	        {eval,{temp,28},{'==',{temp,25},{temp,27}}},
	        {jump,{label,103}},
	        {labdef,{label,104}},
	        ...
	        {eval,{temp,48},{'>',{temp,45},{temp,47}}},
	        {eval,{temp,49},{'=',{temp,3},{temp,48}}},
	        {eval,{temp,50},{labref,{label,101}}},
	        {eval,{temp,51},{load,byte,{temp,50}}},
	        {icon,0},
	        {eval,{temp,53},{labref,{label,100}}},
	        {eval,{temp,54},{load,long,{temp,53}}},
	        {eval,{temp,55},{'<',{temp,52},{temp,54}}},
	        {icon,10},
	        {eval,{temp,57},{'<',{temp,55},{temp,56}}},
	        {eval,{temp,58},{'=',{temp,51},{temp,57}}},
	        {icon,42}],
	       {labdef,{label,102}}}].
...
### ducc -t suite/quiet/semantic/s05.c gives:
	...
	[{proc,{label,"main"},
	       [],
	       [{temp,2},{temp,3},{temp,4},{temp,2},{temp,5},{temp,6}],
	       27,
	       [{icon,0},
	        {arrelem},
	        {icon,a},
	        {eval,{temp,5},{'+',{temp,4},{temp,2}}},
	        {eval,{temp,6},{'=',{temp,3},{temp,5}}}],
	       {labdef,{label,100}}}].
