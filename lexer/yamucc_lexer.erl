...
-file("lexer/yamucc_lexer.xrl", 53).
...
-file("lexer/yamucc_lexer.erl", 291).
yystate() -> 17.
...
yystate(19, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 41 ->
    yystate(0, Ics, Line, Tlen+1, Action, Alen);
...
yystate(7, [C|Ics], Line, Tlen, Action, Alen) when C >= 43, C =< 46 ->
    yystate(0, Ics, Line, Tlen+1, Action, Alen);
yystate(7, [C|Ics], Line, Tlen, Action, Alen) when C >= 48 ->
    yystate(0, Ics, Line, Tlen+1, Action, Alen);
...
yystate(0, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(0, Ics, Line, Tlen+1, Action, Alen);
yystate(0, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 41 ->
    yystate(0, Ics, Line, Tlen+1, Action, Alen);
yystate(0, [C|Ics], Line, Tlen, Action, Alen) when C >= 43, C =< 46 ->
    yystate(0, Ics, Line, Tlen+1, Action, Alen);
